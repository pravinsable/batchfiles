...
REM del /q "%bitbucket%\NuGetFlat\*"
REM for /d %%x in ("%bitbucket%\NuGetFlat\*") do @rd /s /q "%%x"
REM DEL /F /Q /S "\\127.0.0.1\NuGetPackages\*"
REM del /q "\\127.0.0.1\NuGetPackages\*"
REM for /d %%x in ("\\127.0.0.1\NuGetPackages\*") do @rd /s /q "%%x"
...
cd "%bitbucket%\primordial.all.dlls"
git reset --hard
git clean -fxd
git checkout master
git pull
